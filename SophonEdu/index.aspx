    ...
    <body>
                    ...
                    <div class="container">
                        <div class="registration-card">
                            ...
                            <div id="registrationForm" class="registration-form" runat="server">
                                ...
                                <div class="form-group-full">
                                    ...
                                    <div class="learning-path-options">
                                        <label class="path-option">
                                            <%-- Radio buttons can't use asp:RadioButton with RequiredFieldValidator easily --%>
                                            <%-- Keep as HTML but REMOVE the required attribute --%>
                                    ...
                                    <%-- Validate radio selection via CustomValidator --%>
                                ...
                                <asp:Label ID="lblRegisterError" runat="server" CssClass="error-message" ForeColor="Red" Visible="false" />
        ...
        <div class="modal" id="loginModal">
            <div class="modal-content login-container">
                ...
                <h2>Welcome Back</h2>
                <div id="loginForm">
                    <asp:TextBox ID="loginEmail" runat="server" TextMode="Email" CssClass="input" Placeholder="Email Address" />
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="loginEmail" ValidationGroup="LoginGroup" ErrorMessage="Email is required." />
                    <asp:TextBox ID="loginPassword" runat="server" TextMode="Password" CssClass="input" Placeholder="Password" />
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="loginPassword" ValidationGroup="LoginGroup" ErrorMessage="Password is required." />
                    <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="LoginBtnModal" CssClass="btn-primary" ValidationGroup="LoginGroup" />
                </div>
        ...
        <script>
            ...
            // Called by ASP.NET CustomValidator before form submits
            function validateLearningPath(sender, args) {
                const selected = document.querySelector('input[name="learningPath"]:checked');
